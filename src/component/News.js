...
export class News extends Component {
    ...
    async updateNews(){
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=e6343d2df57e4fe79bbe57ccec4f14ea&page=${this.state.page}&pageSize=${this.props.pageSize}`;
        this.setState({loading:true})
        let data = await fetch(url);
        let parsedData = await data.json();
        console.log(parsedData);
        ...
        return (
            <div className='container'>
                ...
                <div className="container d-inline-flex justify-content-between my-3">
                    {/* <div className="btn-group d-inline-flex justify-content-between" aria-label="Basic example"> */}
