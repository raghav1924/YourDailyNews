...
export class News extends Component {
    ...
    async updateNews() {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=dac5bc6be3aa4a82b9f95bd8e66d478a&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    ...
    fetchMoreData = async() => {
        ...
        this.setState({ page: this.state.page+1 });
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=dac5bc6be3aa4a82b9f95bd8e66d478a&page=${this.state.page+1}&pageSize=${this.props.pageSize}`;
        // this.setState({ loading: true });
        let data = await fetch(url);
        let parsedData = await data.json();
